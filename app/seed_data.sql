...
BEGIN
    ...
    ('Unauthorised Access', 'High', '***ENCRYPTED***', NULL, 1, 'Active', NOW() - INTERVAL '5 days'),
    ('Data Leak', 'Critical', '***ENCRYPTED***', NULL, 2, 'Active', NOW() - INTERVAL '3 days'),
    ('Phishing Attempt', 'Medium', '***ENCRYPTED***', NULL, 3, 'Resolved', NOW() - INTERVAL '10 days');
    ...
    WHILE i <= 100 LOOP
        ...
        VALUES (v_type, v_severity, v_details, NULL, v_reporter, v_status, v_created);
